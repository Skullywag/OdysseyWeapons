    ...
    public class CompReloader : CompRangedGizmoGiver
    {
        ...
        public void StartReload()
        {
            ...
            else
            {
                ...
                {
                    MoteThrower.ThrowText(this.Wielder.Position.ToVector3Shifted(), "Reloading", -1);
                }
                Job job = new Job(DefDatabase<JobDef>.GetNamed("OdysseyReloadWeapon", true), this.Wielder, this.parent)
                {
                    playerForced = true
                };
        ...
        public void FinishReload()
        {
            ...
            if (this.reloaderProp.throwMote)
            {
                MoteThrower.ThrowText(this.Wielder.Position.ToVector3Shifted(), "Reloaded", -1);
            }
            this.count = this.reloaderProp.roundPerMag;
